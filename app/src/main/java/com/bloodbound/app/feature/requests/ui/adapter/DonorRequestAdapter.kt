...
class DonorRequestAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        // Blocked if donor has ANY active commitment but hasn't committed to THIS request
        ...
        // Contact row — hidden until committed
        if (alreadyCommitted) {
            b.tvContact.text = "📞 ${req.requesterContactNumber ?: "See My Commitments"}"
            b.tvName.text    = "👤 ${req.requesterName ?: "Requester"}"
        } else {
            b.tvContact.text = "🔒 Hidden until committed"
            b.tvName.text    = "👤 Anonymous"
        }
